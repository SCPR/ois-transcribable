class TranscriptionsController < ActionController::Base
  ...
  def transcription_params
    params.require(:transcription).permit(:civilian_name,:district_attorney_file_number,:district_attorney_county,:district_attorney_date_of_letter,:district_attorney_conclusion,:district_attorney_prepared_report,:narrative_notes,:autopsy_notes,:conclusion_notes,:multiple_officers,:officer_name_and_badge_number,:officer_police_agency,:date_of_incident,:what_happened,:general_location_of_incident,:type_of_incident,:underlying_crime_leading_to_shooting,:how_situation_escalated,:civillian_weapon,:car_stop,:chase_or_pursuit,:civillian_armed,:potential_police_video,:potential_civillian_video,:mention_of_waistband_in_report,:fatal,:case_relevant,:victim_arrested,:victim_case_number,:officer_special_unit,:officer_charges_filed,:officer_charges_filed_yes_detail,:officer_self_defense,:officer_defense_of_civillians,:officer_defense_of_officers,:officer_unknown,:officer_serving_warrant,:officer_on_surveillance,:officer_on_undercover,:pursuit_occurred,:victim_gang_member,:victim_ignored_officer_commands,:victim_weapon_recovered,:victim_initiated_physical_threat)
  end
end
