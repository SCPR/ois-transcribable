class TranscriptionsController < ActionController::Base
    ...
    def update
        ...
        if @transcription.update(transcription_params)
            ...
            @incident.believed_civillian_armed = @transcription.believed_civillian_armed
